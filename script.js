...
const examsData = [
  {
    ...
    officialLink: "https://www.upsc.gov.in/examinations",
...

  {
    ...
    officialLink: "https://ssc.nic.in/Portal/Examinations",
...

  {
    ...
    officialLink: "https://psc.ap.gov.in/psc/#/home",
...

  {
    ...
    searchTerms: ["bank", "po", "banking", "ibps"],
  },

  {
    ...
    officialLink: "https://licindia.in/careers",
    searchTerms: ["insurance", "lic", "aao"],
  },

  {
    ...
    officialLink: "https://slprb.ap.gov.in/",
...

  {
    ...
    officialLink: "https://cse.ap.gov.in/DSE/",
...
const notificationsData = [
  {
    ...
    deadline: "2024-04-15",
    description:
      "UPSC has released the notification for Civil Services Examination 2024. Total 150 vacancies. Last date to apply is April 15, 2024.",
  },
  {
    id: 2,
    ...
    deadline: "2024-04-05",
    description:
      "SSC has released the admit cards for CGL 2024. Download from the official website. Exam date is April 5, 2024.",
  },
  {
    id: 3,
    ...
    deadline: null,
    description:
      "Previous year papers for RRB NTPC are now available for download.",
  },
  {
    id: 4,
    ...
    deadline: "2024-04-10",
    description:
      "State Education Department has opened registration for Teacher Recruitment Drive. 10,000 vacancies announced.",
  },
  {
    id: 5,
    ...
    deadline: "2024-04-20",
    description:
      "Bank PO 2024 application deadline extended to April 20, 2024. Apply immediately.",
  },
  {
    id: 6,
    ...
    deadline: "2024-05-01",
    description:
      "State Police Department announced the exam schedule. Preliminary exam on May 1, 2024.",
  },
];
...
function populateExams(filterType = "all") {
  ...
  let data =
    filterType === "all"
      ? examsData
      : examsData.filter((e) => e.level === filterType);
...
function populatePapers() {
  displayPapers(papersData.slice(0, 6));
}
...
function displayPapers(papers) {
  ...
  if (!papers.length) {
    container.innerHTML =
      '<p style="text-align:center;grid-column:1/-1;padding:2rem">No papers found.</p>';
    return;
  }
...
function populateNotifications() {
  displayNotifications(notificationsData.slice(0, 4));
}
...
function getStatusLabel(s) {
  return (
    { latest: "🆕 Latest", urgent: "🔴 Urgent", upcoming: "📌 Upcoming" }[s] ||
    s
  );
}
...
function toggleFAQ(el) {
  ...
  document.querySelectorAll(".faq-answer").forEach((f) => {
    if (f !== answer) f.classList.remove("active");
  });
...
function switchTab(tabName, groupClass) {
  ...
  document
    .querySelector(`.tab-btn[data-tab="${tabName}"][data-group="${group}"]`)
    ?.classList.add("active");
  document
    .querySelector(`.tab-content[data-tab="${tabName}"][data-group="${group}"]`)
    ?.classList.add("active");
}
...
function setupScrollAnimations() {
  ...
  document
    .querySelectorAll(
      ".exam-card,.paper-card,.notification-card,.quick-link-card,.info-card,.test-card,.cal-card",
    )
    .forEach((card) => {
